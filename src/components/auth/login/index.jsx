            ...
            <main className="w-full h-screen flex self-center place-content-center place-items-center">
                <div className="w-96 text-gray-600 space-y-5 p-4 shadow-xl border rounded-xl">
                    <div className="text-center">
                        <div className="mt-2">
                            <h3 className="text-gray-800 text-xl font-semibold sm:text-2xl">Bienvenido a Hidroplant</h3>
                        </div>
                    </div>
                    <form
                        onSubmit={onSubmit}
                    ...
                    <p className="text-center text-sm">¿No tienes una cuenta? <Link to={'/register'} className="hover:underline font-bold">Registrate</Link></p>
                    ...
                    <button
                        ...
                        {isSigningIn ? 'Inciando sesión...' : 'Iniciar sesión con Google'}
                    </button>
                </div>
            </main>
        </div>
